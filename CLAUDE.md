...
`?wrapPreset=<draped|parisian|infinity|blanket|ascot>` (**pre-tied wrap presets** — one-click named scarf looks that set an exclusive worn-state + a flattering width over the knot/double/blanket/pin mechanics; `avatar/wrapPresets`, also a picker in the scarf panel) ·
