...
`?brimWidth=<0.4..2.2>&brimDroop=<-1..1>&brimWire=1` (the **parametric brim designer** — width · droop/flip · a wired edge on the bucket + sun-hat blocks; pure `avatar/brim.brimProfile`) ·
