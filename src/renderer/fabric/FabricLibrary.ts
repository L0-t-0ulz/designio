...
export type WeaveType = 'plain' | 'twill' | 'satin' | 'knit' | 'rib' | 'waffle' | 'cable' | 'corduroy' | 'leather' | 'basketweave' | 'houndstooth' | 'birdseye-dobby' | 'pique'
...
export const FABRIC_LIBRARY: Fabric[] = [
  ...
  { id: 'hopsack', name: 'Hopsack', family: 'woven', gsm: 280, stretch: 0.05, bendiness: 0.28, friction: 0.55, color: 0x565b48, roughness: 0.86, sheen: 0.4, sheenRoughness: 0.6, weave: 'basketweave', weaveScale: 110, normalStrength: 0.8, anisotropy: 0, transmission: 0 },
  { id: 'birdseye-suiting', name: "Bird's-eye suiting", family: 'woven', gsm: 270, stretch: 0.04, bendiness: 0.24, friction: 0.5, color: 0x3e4756, roughness: 0.8, sheen: 0.5, sheenRoughness: 0.55, weave: 'birdseye-dobby', weaveScale: 210, normalStrength: 0.55, anisotropy: 0.05, transmission: 0 },
  ...
  { id: 'houndstooth-wool', name: 'Houndstooth wool', family: 'woven', gsm: 300, stretch: 0.04, bendiness: 0.26, friction: 0.55, color: 0x3a3a3a, roughness: 0.84, sheen: 0.35, sheenRoughness: 0.6, weave: 'houndstooth', weaveScale: 150, normalStrength: 0.6, anisotropy: 0.05, transmission: 0 },
