...
export type ExportFormat = 'glb' | 'usdz' | 'obj' | 'svg' | 'dxf' | 'pattern-tiled' | 'techpack' | 'json' | 'manufacture' | 'factory-json' | 'size-set' | 'listing' | 'product-page' | 'portfolio' | 'configurator' | 'tryon-widget' | 'separations' | 'bag-pattern' | 'shoe-pattern'
