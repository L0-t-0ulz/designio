...
export type ExportFormat = 'glb' | 'glb-draco' | 'usdz' | 'obj' | 'stl' | 'svg' | 'dxf' | 'plt' | 'pattern-tiled' | 'techpack' | 'json' | 'manufacture' | 'factory-json' | 'size-set' | 'listing' | 'product-page' | 'portfolio' | 'configurator' | 'tryon-widget' | 'separations' | 'bag-pattern' | 'shoe-pattern' | 'mobile'
