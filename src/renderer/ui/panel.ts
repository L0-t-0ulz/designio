...
export type ExportFormat = 'glb' | 'usdz' | 'obj' | 'svg' | 'dxf' | 'pattern-tiled' | 'techpack' | 'json' | 'manufacture' | 'factory-json' | 'size-set' | 'listing' | 'product-page' | 'portfolio' | 'configurator' | 'tryon-widget' | 'separations' | 'bag-pattern' | 'shoe-pattern' | 'mobile'
...
export function createControlPanel(opts: PanelOptions): { panel: HTMLElement; api: PanelApi } {
  ...
  const WEAR_LABELS: Record<WearKind, string> = { faded: 'Faded', 'acid-wash': 'Acid-wash', distressed: 'Distressed', adaptive: 'Adaptive', 'stone-wash': 'Stone-wash', 'enzyme-wash': 'Enzyme-wash', 'tie-dye': 'Tie-dye', shibori: 'Shibori', batik: 'Batik' }
